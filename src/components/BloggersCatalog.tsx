        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-5 list-none p-0 m-0">
          {sortedBloggers.map((blogger) => {
            ...
            return (
              <li
                key={blogger.id}
                className="bg-white border border-purple-100/90 hover:border-purple-300 rounded-3xl p-5 shadow-sm hover:shadow-md transition-all flex flex-col justify-between group relative overflow-hidden"
              >
                <div
                  className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-violet-500 via-purple-500 to-pink-500 opacity-80"
                  aria-hidden="true"
                />
                  ...
                  <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="relative shrink-0">
                        ...
                        {blogger.isVerified && (
                          <span
                            className="absolute -bottom-1 -right-1 bg-gradient-to-r from-pink-500 to-rose-500 text-white p-0.5 rounded-full shadow-xs"
                            title="Tasdiqlangan bloger"
                          >
                            <CheckCircle2 className="w-3.5 h-3.5" aria-hidden="true" />
                            <span className="sr-only">Tasdiqlangan</span>
                          </span>
                        )}
                      </div>
